    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        if (responseData.containsKey('medicationReminders')) {
          ...
          throw Exception('Unexpected response format: "medicationReminders" key not found');
        }
    ...
    return Card(
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            const Text('Past Medication Reminders:', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16)),
  ...
  Widget _buildMedicationInfo() {
    return Column(
      ...
      children: const [
        ...
        Text('- Use alarms or notifications to avoid missing doses.'),
        Text('- Store medications safely out of reach of children.'),
        Text('- Inform your healthcare provider about all medications you take.'),
      ],
    );
  }
